...
export default function LinksWindow(){
    return(
        <div className="bg-white p-12">
            <div className="flex gap-10 items-center text-center justify-center text-6xl text-gray-600">
                <Link href={'/e'} target="blank" className="hover:text-black hover:scale-110">
