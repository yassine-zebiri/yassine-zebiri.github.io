            ...
            <div>
                ...
                <div>
                    {projects.map((item,index)=>(
                        <div className="flex flex-col sm:flex-row p-3 py-10 border-b border-b-gray-300" key={index}>
                            <div className="" style={{display:'contents'}}>
                                <Image className="rounded-xl  border-3 border-gray-400 w-full sm:w-fit" 
