...
export default function AboutWindow(){
    return(
        <div className="text-white bg-slate-800 p-3" >
            ...
            <div className="flex justify-center flex-col lg:flex-row items-center gap-5 py-5 border-b">
                ...
                <div className="text-center flex flex-col gap-3 items-center">
                    <h2 className="sm:text-4xl text-2xl font-bold">Yassine Zebiri</h2>
                    <h3 className="sm:text-lg text-sm font-extralight">hi ,i'm developer web and freelance</h3>
                    <a className="btn btn-primary cursor-pointer" href="./assets/Yassine_Zebiri.pdf" download>
